(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "fable-core", "./../common/common"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("fable-core"), require("./../common/common"));
  } else {
    var mod = {
      exports: {}
    };
      ...
      value: function getData(tfs) {
        ...
        return function (builder_) {
          return builder_.Delay(function (unitVar) {
            ...
            return builder_.Bind(_common.Http.Request("GET", concatUrl(_this3.root, url)), function (_arg1) {
              return builder_.Return(JSON.parse(_arg1));
            });
          });
        }(_fableCore.AsyncBuilder.singleton);
